<h2><a href="https://www.geeksforgeeks.org/problems/maximum-sum-problem2211/1?_gl=1*1bmqnr1*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjws-S-BhD2ARIsALssG0ZYmsa0nFx8ITiKp8LXdOhdnirQIugao7B_UcpX4kC9MTWGhHRFZvEaAr3_EALw_wcB">Maximum Sum Problem</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p dir="ltr">Given a number&nbsp;<strong><strong>n, </strong></strong>find its maximum sum value with 3 recursive breaks described below.</p>
<ul>
